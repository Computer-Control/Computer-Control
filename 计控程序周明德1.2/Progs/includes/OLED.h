...
#define LCD_SCL_CLR()	GPIO_ResetBits(GPIOB,GPIO_Pin_8)
#define LCD_SCL_SET()	GPIO_SetBits(GPIOB,GPIO_Pin_8)

#define LCD_SDA_CLR()	GPIO_ResetBits(GPIOC,GPIO_Pin_15)
#define LCD_SDA_SET()	GPIO_SetBits(GPIOC,GPIO_Pin_15)

#define LCD_RST_CLR()	GPIO_ResetBits(GPIOB,GPIO_Pin_9)
#define LCD_RST_SET()	GPIO_SetBits(GPIOB,GPIO_Pin_9)

#define LCD_DC_CLR()	GPIO_ResetBits(GPIOB,GPIO_Pin_10)
